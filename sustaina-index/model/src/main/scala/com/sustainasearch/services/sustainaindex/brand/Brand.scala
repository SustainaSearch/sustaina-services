...
case class Brand(id: Int,
				 ...
				 // Processes
				 no_perfluorinated_compounds_used: Int, // max 5p, yes = 5 , other = 0
				 no_added_biocides_for_antibacterial_purpose: Int, // max 5p, yes = 5 , other = 0
				 no_pvc_with_ftalates_used: Int, // max 5p, yes = 5 , other = 0
				 bleach_ban: Int, // max 5p, yes = 5, other = 0, wool, cotton & natural fibers from cellulose
				 chloride_treatment_ban: Int, // max 5p, yes = 5, other = 0, material wool
				 chloric_gas_bleach_ban: Int, // max 5p, yes = 5, other = 0, cellulosa based textile mass
				 ...
				 //packaging
				 recycled_packaging_percent: Int, // Max 10p, Minimerar paketering - Hur pongstter vi, verifikat?
				 ...
				 //organic solvants
				 members_in_CRS_organisation: Int, // max 10p, yes = 10, second hand = 10p, other = 0
